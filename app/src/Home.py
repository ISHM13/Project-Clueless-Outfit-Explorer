...
st.title('Clueless: The Ultimate Outfit Explorer')
st.write('\n\n')
# st.write('### Overview:')
# st.write('\n')
...
if st.button("Act as Rachel Green, the general consumer.", 
            type = 'primary', 
    ...
    logger.info("Logging in as the Consumer Persona")
    st.switch_page('pages/00_Consumer_Home.py')

if st.button('Act as Alison Preistly, an data analyst', 
            type = 'primary', 
            use_container_width=True):
    st.session_state['authenticated'] = True
...
if st.button('Act as Rebecca, an Business Owner', 
            type = 'primary', 
            use_container_width=True):
    st.session_state['authenticated'] = True
    ...
    st.switch_page('pages/_36_Business_Home.py')
